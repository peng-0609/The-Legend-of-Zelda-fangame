...
namespace Sprint2
{ 
    class LinkDownAttackState: ILinkState
    {
        ...
        public LinkDownAttackState(Link link, Game1 game)
        {
            this.link = link;
            this.game = game ;
            linkSprite = LinkSpriteFactory.Instance.CreateLinkAttackDownSprite();
            ...
            sword = new AttackSword((int)link.Position.X, (int)link.Position.Y+linkSprite.Height, this.link.linkphysicalProperty.direction);
            sword.UseProjectile();
