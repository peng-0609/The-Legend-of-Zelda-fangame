...
namespace Sprint2
{
    public class ShootedArrowLeftState : IProjectileState
    {
        ...
        public ShootedArrowLeftState(ShootedArrow arrow)
        {
            this.arrow = arrow;
            arrowSprite = ProjectileSpriteFactory.Instance.CreateShootedArrowSprite(Direction.LEFT);
            //direction
