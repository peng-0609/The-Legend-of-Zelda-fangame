...
namespace Sprint2
{
    class LinkLeftAttackState : ILinkState
    {
        ...
        public LinkLeftAttackState(Link link, Game1 game)
        {
            this.link = link;
            ...
            sword = new AttackSword((int)link.Position.X-24, (int)link.Position.Y+13, this.link.linkphysicalProperty.direction);
            sword.UseProjectile();
